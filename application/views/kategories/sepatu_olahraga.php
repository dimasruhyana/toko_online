<div class="container-fluid">
   ...
   <!-- judul -->
   <div class="judul">
      <h1 class="text-center text-dark">Sepatu Olahraga</h1>
   </div>

   <?php if (empty($sepatu_olahraga)) : ?>
      <div class="row">
            ...
            <div class="content">
               <div class="card text-center ml-3 mt-2 mb-3">
                  ...
                  <div class="card-body bg-light">
                     ...
                     <div class="aksi">
                        <a href="<?= base_url(); ?>Dashboard/tambah_ke_keranjang/<?= $brg['id']; ?>" class="btn btn-primary btn-sm">Tambah ke keranjang</a>
