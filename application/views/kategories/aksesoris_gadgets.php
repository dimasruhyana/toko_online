<div class="container-fluid">
   ...
   <div class="judul">
      <h1 class="text-center text-dark">Aksesoris Gadgets</h1>
   </div>

   <?php if (empty($aksesoris_gadgets)) : ?>
      <div class="row">
      ...
      <div class="row">
         ...
         <!-- card produk -->
         <?php foreach ($aksesoris_gadgets as $brg) : ?>
            <div class="content">
               <div class="card text-center ml-3 mt-2">
                  ...
                  <div class="card-body bg-light">
                     ...
                     <div class="aksi">
                        <a href="<?= base_url() ?>Dashboard/tambah_ke_keranjang" class="btn btn-primary btn-sm">Tambah ke keranjang</a>
